...
List* merge(List* l1, List* l2)
{
    ...
    Node* l1_temp = l1->node->next;
    Node* l2_temp = l2->node->next;

    l1->node->next = l2_temp;
    l2_temp->prev = l1->node;

    l2->node->next = l1_temp;
    l1_temp->prev = l2->node;
